...
A set of scripts that deploy [dss](http://github.com/monolithos/dss) to an
...
```
{
  ...
  "vat_line": "<General debt ceiling in MCR unit>",
  "vow_wait": "<Flop delay in seconds>",
  "vow_sump": "<Flop fixed bid size in MCR unit>",
  "vow_dump": "<Flop initial lot size in MDT unit>",
  "vow_bump": "<Flap fixed lot size in MCR unit>",
  "vow_hump": "<Flap Surplus buffer in MCR unit>",
  "jug_base": "<Base component of stability fee in percentage per year (e.g. 2.5)>",
  "pot_dsr": "<MCR Savings Rate in percentage per year (e.g. 2.5)>",
  "end_wait": "<Global Settlement cooldown period in seconds>",
  "esm_pit": "<Pit address to send MDT to be burnt when ESM is fired>",
  "esm_min": "<Minimum amount to trigger ESM in MDT unit>",
    ...
    "<ETH|COL>": {
      ...
      "ilks": {
        "A": {
          ...
          "line": "<Debt ceiling value in MCR unit>",
          "dust": "<Min amount of debt a CDP can hold in MCR unit>"
...
```
nix run -f https://github.com/monolithos/dss-deploy-scripts/tarball/master -c dss-deploy testchain
```
...
- `dss-deploy` [source code](https://github.com/monolithos/dss-deploy)
- `dss` is documented in the [wiki](https://github.com/monolithos/dss/wiki) and in [DEVELOPING.md](https://github.com/monolithos/dss/blob/master/DEVELOPING.md)
...
export DSR_MANAGER=0x373238337Bfe1146fb49989fc222523f83081dDb
...
export PIP_USDC=0x77b68899b99b686F415d074278a9a16b336085A0
export MCD_JOIN_USDC_A=0xA191e578a6736167326d05c119CE0c90849E84B7
export MCD_FLIP_USDC_A=0xE6ed1d09a19Bd335f051d78D5d22dF3bfF2c28B1
export MCD_JOIN_USDC_B=0x2600004fd1585f7270756DDc88aD9cfA10dD0428
export MCD_FLIP_USDC_B=0xec25Ca3fFa512afbb1784E17f1D414E16D01794F
export WBTC=0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
export PIP_WBTC=0xf185d0682d50819263941e5f4EacC763CC5C6C42
export MCD_JOIN_WBTC_A=0xBF72Da2Bd84c5170618Fbe5914B0ECA9638d5eb5
export MCD_FLIP_WBTC_A=0x3E115d85D4d7253b05fEc9C0bB5b08383C2b0603
export TUSD=0x0000000000085d4780B73119b644AE5ecd22b376
export PIP_TUSD=0xeE13831ca96d191B688A670D47173694ba98f1e5
export MCD_JOIN_TUSD_A=0x4454aF7C8bb9463203b66C816220D41ED7837f44
export MCD_FLIP_TUSD_A=0xba3f6a74BD12Cf1e48d4416c7b50963cA98AfD61
